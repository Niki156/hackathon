...
import static com.epam.hackathon.constants.ConstantsSetUp.CREDENTIALS_FILE_PATH;

public class DataBaseUtility {
    Properties credentials = PropertyFileReader.getPropLoader(CREDENTIALS_FILE_PATH);
